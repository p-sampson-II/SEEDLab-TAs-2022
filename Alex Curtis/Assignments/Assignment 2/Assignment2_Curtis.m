...
% change load_system to open_system.
%% Motor Parameters
...
load_system('motorsim')          % Load the model
out1 = sim('motorsim');
...
load_system('motorPWM')         % Load the model 
PWMout = sim('motorPWM');
...
load_system('motorQuantized')   % Load the model
...
load_system('motor');                       % Load the model
...
load_system('motorWithTF')                  % Load the model
...
load_system('TFLoopPI')                     % Load the PI controlled TF model
load_system('motorLoopPI')                  % Load the PI controlled motor model
tfOut = sim('TFLoopPI');
...
load_system('TFLoopPD')
load_system('motorLoopPD')
tfOut = sim('TFLoopPD');
